...
def general_settings():
    ...
    parser.add_argument('--Tlen', type=int, default=100, metavar='length',
                        help='input sequence length')
    parser.add_argument('--Tlen_test', type=int, default=100, metavar='test-length',
    ...
    parser.add_argument('--nSteps', type=int, default=1000, metavar='N_steps',
